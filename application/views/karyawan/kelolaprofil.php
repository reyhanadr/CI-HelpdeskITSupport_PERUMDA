                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12" style="border-right: 1px solid #eee;">
                                        ...
                                        <form method="post"
                                            ...
                                            action="<?php echo site_url('Karyawan/Profil/updateDataProfile/'.$this->session->userdata('user_id')); ?>"
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <?php elseif ($ticket->status == 'BERJALAN' || $ticket->status == 'SELESAI' || $ticket->status == 'DIPAKAI'): ?>
                                ...
                                <div class="modal-dialog" role="document">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <form method="post" action="<?php echo site_url('Karyawan/Profil/gantiPassword'); ?>">
