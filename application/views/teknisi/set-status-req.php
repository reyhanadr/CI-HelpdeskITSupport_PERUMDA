                            ...
                            <div class="tab-pane fade show active" id="tab-1">
                                <div class="row">
                                    <div class="col-md-12" style="border-right: 1px solid #eee;">
                                        <form method="post"
                                            action="<?php echo site_url('Teknisi/KelolaRequest/setStatusTo'); ?>/<?php echo $supportticket->request_id; ?>"enctype="multipart/form-data">
                                            <div class="row">
                                                <div class="col-sm-6 form-group">
                                                    <label class="font-bold">Nomer Seri Perangkat</label>
                                                    <p class=""><?php echo $supportticket->nomer_seri; ?></p>
                                                </div>
                                                <div class="col-sm-6 form-group">
                                            ...
                                            <div class="form-group">
                                                <label class="font-bold">Status Perbaikan</label>
                                                <select class="form-control" name="status">
                                                    <option value="SELESAI">Telah Diperbaiki</option>
                                                    <option value="RUSAK">Tidak Dapat Diperbaiki</option>
                                                </select>
                                            </div>
                                            <div class="form-group">
                                                <label class="font-bold">Catatan Perbaikan</label>
